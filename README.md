...
- Influence-Directed Explanations for Deep Convolutional Networks [[pdf]](https://openreview.net/pdf?id=SJPpHzW0-)
...
- Vision Transformers Don't Need Trained Registers [[pdf]](https://arxiv.org/pdf/2506.08010) [[code]](https://github.com/nickjiang2378/test-time-registers/tree/main) [[website]](https://avdravid.github.io/test-time-registers/)
...
- **[B-cos-v2]** B-cos Alignment for Inherently Interpretable CNNs and Vision Transformers [[pdf]](https://arxiv.org/pdf/2306.10898) [[code]](https://github.com/B-cos/B-cos-v2)
...
- **[MoreauGrad]** Sparse and Robust Interpretation of Neural Networks via Moreau Envelope [[pdf]](https://openaccess.thecvf.com/content/ICCV2023/papers/Zhang_MoreauGrad_Sparse_and_Robust_Interpretation_of_Neural_Networks_via_Moreau_ICCV_2023_paper.pdf) [[code]](https://github.com/buyeah1109/MoreauGrad)
...
- **[CF-CBM]** Coarse-to-Fine Concept Bottleneck Models [[pdf]](https://openreview.net/pdf?id=RMdnTnffou) [[code]](https://github.com/konpanousis/Coarse-To-Fine-CBMs)
- **[DCBM]** Data-Efficient Visual Concept Bottleneck Models [[pdf]](https://arxiv.org/pdf/2412.11576)
...
## Feature Visualization and Model Inversion
...
- Traditional Classification Neural Networks are Good Generators: They are Competitive with DDPMs and GANs [[pdf]](https://arxiv.org/pdf/2211.14794) [[code]](https://github.com/wanggrun/CaG) [[website]](https://classifier-as-generator.github.io/)
...
- **[JAFAR]** Jack up Any Feature at Any Resolution [[pdf]](https://arxiv.org/pdf/2506.11136) [[code]](https://github.com/PaulCouairon/JAFAR) [[website]](https://jafar-upsampler.github.io/)
...
- Large Multi-modal Models Can Interpret Features in Large Multi-modal Models [[pdf]](https://arxiv.org/pdf/2411.14982) [[code]](https://github.com/EvolvingLMMs-Lab/multimodal-sae) [[demo]](https://huggingface.co/spaces/lmms-lab/Multimodal-SAE)
...
- Investigating Gender Bias in Language Models Using Causal Mediation Analysis [[pdf]](https://proceedings.neurips.cc/paper/2020/file/92650b2e92217715fe312e6fa7b90d82-Paper.pdf)
